...
const FAQ_CATEGORIES = [
  {
    title: 'サービス基本情報',
    items: [
      { q: 'AI 波予報とは何ですか？', a: 'AI 波予報（jpwaveforecast.com）は、AIが湘南・千葉北・千葉南・茨城の波をリアルタイムで自動分析する波予報アプリです。波高・風・うねり・潮位などのデータをAIが総合的に判断し、サーファーのレベルとボードに合わせたパーソナライズスコアを提供します。完全無料・登録不要で利用できます。' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'クローズアウトとは何ですか？', a: '波が大きすぎてサーフィンができない危険な状態です。AI 波予報では波高2.5mを超える場合、またはオンショアの強風（10m/s以上）が伴う場合にクローズアウトと判定し、スコア非表示・「危険 / クローズアウト」と表示します。このコンディションでの入水は絶対に避けてください。' },
