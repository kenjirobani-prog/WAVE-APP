        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              { "@type": "Question", "name": "波のスコアはどうやって計算されますか？", "acceptedAnswer": { "@type": "Answer", "text": "波高（25点）・風（22点）・うねり方向（18点）・波質（20点）・潮位（10点）・天気（5点）の合計100点満点でAIがスコア化し、朝・昼・夕方の3時間帯ごとに★1〜5の星で表示します。設定したレベルとボードに合わせて補正されます。" } },
              ...
              { "@type": "Question", "name": "スポット詳細ページではどんな情報が見られますか？", "acceptedAnswer": { "@type": "Answer", "text": "朝・昼・夕方の星評価・AIコメント・波高・風速・うねり方向・周期・波質・潮位グラフ・1時間ごとの予報を確認できます。" } },
